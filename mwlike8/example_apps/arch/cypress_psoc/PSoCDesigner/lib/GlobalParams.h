...
#define PORT_3_GLOBAL_SELECT   0xa0    //Port 3 global select register (PRT3GS)
#define PORT_3_DRIVE_0         0xdf    //Port 3 drive mode 0 register (PRT3DM0)
#define PORT_3_DRIVE_1         0x2a    //Port 3 drive mode 1 register (PRT3DM1)
#define PORT_3_DRIVE_2         0x0     //Port 3 drive mode 2 register (PRT3DM2)
#define PORT_3_INTENABLE       0xa     //Port 3 interrupt enable register (PRT3IE)
#define PORT_3_INTCTRL_0       0xa     //Port 3 interrupt control 0 register (PRT3IC0)
#define PORT_3_INTCTRL_1       0xa     //Port 3 interrupt control 1 register (PRT3IC1)
#define PORT_4_GLOBAL_SELECT   0x0     //Port 4 global select register (PRT4GS)
#define PORT_4_DRIVE_0         0xff    //Port 4 drive mode 0 register (PRT4DM0)
#define PORT_4_DRIVE_1         0xa     //Port 4 drive mode 1 register (PRT4DM1)
...
#define PORT_5_DRIVE_0         0xf     //Port 5 drive mode 0 register (PRT5DM0)
#define PORT_5_DRIVE_1         0x8     //Port 5 drive mode 1 register (PRT5DM1)
...
#define PORT_5_INTCTRL_0       0x8     //Port 5 interrupt control 0 register (PRT5IC0)
