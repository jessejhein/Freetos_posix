 ...
 *	app.h
 *
 *	header file for mwlike8 original
 *
 *	06-05-2004	yan	created
 *
 */
...
#define	I2C_MOD		0
	...
	#endif
			// switch case mode
			//	this switch case must mix gui, mwlike8 together
