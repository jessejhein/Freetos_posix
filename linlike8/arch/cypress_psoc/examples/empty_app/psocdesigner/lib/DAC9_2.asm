...
;-----------------------------------------------
export  DAC9_2_Start
export _DAC9_2_Start
export  DAC9_2_SetPower
export _DAC9_2_SetPower

export  DAC9_2_WriteBlind
export _DAC9_2_WriteBlind
export  DAC9_2_WriteBlind2B
export _DAC9_2_WriteBlind2B

export  DAC9_2_WriteStall
export _DAC9_2_WriteStall
export  DAC9_2_WriteStall2B
export _DAC9_2_WriteStall2B
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC9_2_Start
;  FUNCTION NAME: DAC9_2_SetPower
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC9_2_WriteBlind
;  FUNCTION NAME: DAC9_2_WriteBlind2B
;
;  DESCRIPTION:
...
_DAC9_2_WriteBlind:
  ...
  IF DAC9_2_OFFSETBINARY | DAC9_2_TWOSCOMPLEMENT
    swap  A, X                  ;  A <- upper, X <- lower
...
BlindMagSet:
 ...
 DAC9_2_WriteBlind2B:
_DAC9_2_WriteBlind2B:
; IF DAC9_2_SIGNANDMAGNITUDE
    or   A,bHIGHBITS            ; LSB: 10t21000
    swap A,X                    ; LSB in X, MSB in A
    or   A,bHIGHBITS            ; MSB: 10s76543
    mov  reg[DAC9_2_MSB_CR0],A
    mov  A,X                    ; LSB in A
    mov  reg[DAC9_2_LSB_CR0],A
; ENDIF
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: DAC9_2_WriteStall
;  FUNCTION NAME: DAC9_2_WriteStall2B
;
;  DESCRIPTION:
...
_DAC9_2_Stop:
    ...
    and  reg[DAC9_2_MSB_CR3], ~bPWRMASK
    and  reg[DAC9_2_LSB_CR3], ~bPWRMASK
    RAM_EPILOGUE RAM_USE_CLASS_1 
    ret
.ENDSECTION

; End of File DAC9_2.asm
