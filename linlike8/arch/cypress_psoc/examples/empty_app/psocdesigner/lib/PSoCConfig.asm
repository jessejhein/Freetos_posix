...
export LoadConfig_aaa
export _LoadConfig_aaa
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfigTBL_aaa_Ordered
	lcall	LoadConfig_aaa

    RAM_EPILOGUE RAM_USE_CLASS_4
    ret

;---------------------------------------------------------------------------
; Load Configuration aaa
;
;    Load configuration registers for aaa.
...
_LoadConfig_aaa:
 LoadConfig_aaa:
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_aaa_Bank0
    mov     X, <LoadConfigTBL_aaa_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_aaa_Bank1
    mov     X, <LoadConfigTBL_aaa_Bank1
