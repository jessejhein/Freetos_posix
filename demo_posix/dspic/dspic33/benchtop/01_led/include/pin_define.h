 ...
 * ==MAPS==
 **************************************************************************/
#define disClk                  LATF &= 0xFFFD     //_RF1
#define enClk                   LATF |= 0x0002
#define enWr                    LATF &= 0xFFFE     //_RF0
#define enRd                    LATF |= 0x0001
#define enCsP                   LATD &= 0xFFBF     //_RD6
#define disCsP                  LATD |= 0x0040
#define lowA0P                  LATD &= 0xF7FF     //_RD11
#define highA0P                 LATD |= 0x0800
#define enResetP                LATD &= 0xFF7F     //_RD7
#define disResetP               LATD |= 0x0080
...
#if (TEC_T>=6)
#define TEMP_PIN_6() {\
    unsigned char ctrl_buf = 5;        /*CASE_TEMP*/\
    ioctl(fd_adc, ADC_ADD_CH, &ctrl_buf);\
}
#endif
