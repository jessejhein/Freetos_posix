...
//  ============================Device Config==================================== 
#define ETH_INT_EP                  INTCON2bits.INT0EP
#define ETH_INT_IF                  IFS0bits.INT0IF
#define ETH_INT_IP                  IPC0bits.INT0IP
#define ETH_INT_IE                  IEC0bits.INT0IE
#define dmfe_interrupt()            void _ISR _INT0Interrupt(void)
//#define ETH_IOW0                    _RG6
//#define ETH_IOR0                    _RG7
//#define ETH_CMD                     _RG8
//#define ETH_CS0                     _RG9
//  ============================MARCOS===========================================
