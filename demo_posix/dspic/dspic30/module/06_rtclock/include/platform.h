...
#define UART_DEFAULT_BRG            ( (unsigned int) \
                                        ...
                                        /   ( (unsigned long) 16*UART_BAUDRATE) ) \
                                        - 1 \
                                     )
#endif //UART_MOD
...
#define BASE_PUSH_KEY               GR_KEY_ENTER    // starting key id for push keys
...
#define BASE_ROTARY_KEY             GR_SPECIAL_KEY_ARROW_UP // starting key id for rotary keys
#define TOTAL_ROTARY_KEY            1                       // Total number of rotary key, each key has 2 id (up and down)
#define ROTARY_KEY0_UP              BASE_ROTARY_KEY
#define ROTARY_KEY0_DN              GR_SPECIAL_KEY_ARROW_DOWN
