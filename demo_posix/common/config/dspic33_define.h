/************************************************************************************************
 * File:            define.h
 * Description:     Your Apllication configuration
 ***********************************************************************************************/
...
#define RS485_CTL_EN()              //Any DO pin                //_TRISG1=0
#define RS485_TX_ON()               //Any DO pin set to 1       //_RG1=1      
#define RS485_TX_OFF()              //Any DO pin set to 0       //_RG1=0
//  ============================Buffer Size====================================== 
...
#define NVM_SRC                      NVM_SRC_FLASH   //Select which EEPROM is used
//  ==========================I2C EEPROM Config==================================
...
// ETHERNET Module ***************************************************************
#define ETHERNET_MOD                0       // ethernet enable
#if (ETHERNET_MOD>0)
//  ============================Device Handler=================================== 
