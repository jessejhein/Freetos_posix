 ...
 * +-- Note that this value is only used by heap_1.c or heap_2.c.
 *     When one of these dynamic memory management is used, this
 *     value cannot be greater than 6Kb (total .nbss + .ndata < 8Kb). 
 *     Should a larger size is needed, use heap_3.c and set the
 *     required heap size in the makefile. However, the program size
 *     will be increased by 603bytes
 */
