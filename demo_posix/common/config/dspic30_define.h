...
#define RS485_CTL_EN()              //Any DO pin, such as _TRISF6=0
#define RS485_TX_ON()               //Any DO pin set to 1, such as _RF6=1      
#define RS485_TX_OFF()              //Any DO pin set to 0, such as _RF6=0
//  ============================Buffer Size====================================== 
...
// EEPROM Module ****************************************************************
#define EEPROM_MOD                  1           // eeprom enable
#if (EEPROM_MOD>0)
//  ============================Device Handler=================================== 
