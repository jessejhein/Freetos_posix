 ...
 * @{
 *
 * Control U0ART (RS232) and U1ART (RS485)
 * \li The UART module consists of 3 channels.
 * \li U0ART is referenced by COM0, U1ART is referenced by COM1, U2ART is referenced by COM2.
 *     By default, U0ART is used for RS232 communication,
 *     U1ART is used for LCD
 *     and U2ART is used for RS485 communication.
 ...
 * \li When RS232 (U1ART) detects a break character, it resets the system for bootloader application
 */
...
#ifdef UART_MOD
/**
 * \brief map pins for UART modules (PPS). Required on dsPic33E platform
 * \remarks implement externally
 */
extern void uart_pin_init (void);


/**
 * \brief Initialise UART Ports
 * \param device UART port id
 * \n             device 0 = U0ART (RS232)
 * \n             device 1 = U1ART (LCD)
 * \n             device 2 = U2ART (RS485)
